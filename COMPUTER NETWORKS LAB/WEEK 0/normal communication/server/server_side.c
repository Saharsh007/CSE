...
{ 
    ...
    for (;;) { 
        ...
        //From the file indicated by the file descriptor fs, the read() function reads N bytes of input into the memory area 
...
/*
netinet includes sockaddr which is a structure with the following fields...
...
protocol family. Values of this type must be cast to struct sockaddr for use with 
the socket interfaces defined in this document.
...
int main(){
    ...
    htons - unsigned short integerrger
	*/
